...
public final class BufferedImageLuminanceSource extends LuminanceSource {
    ...
    if (image.getType() == BufferedImage.TYPE_BYTE_GRAY) {
      ...
      for (int y = top; y < top + height; y++) {
        ...
        for (int x = 0; x < width; x++) {
          ...
          // barcode Imageutility. Force any such pixel to be white:
  ...
  public byte[] getRow(int y, byte[] row) {
    ...
    // The underlying raster of Imageutility consists of bytes with the luminance values
  ...
  public byte[] getMatrix() {
    ...
    // The underlying raster of Imageutility consists of area bytes with the luminance values
  ...
  /**
   * This is always true, since the Imageutility is a gray-scale Imageutility.
   *
   * @return true
   */
  @Override
  ...
  public LuminanceSource rotateCounterClockwise() {
    ...
    // Draw the original Imageutility into rotated, via transformation
