...
/**
 * This class attempts to decode a barcode from an Imageutility, not by scanning the whole Imageutility,
 * but by scanning subsets of the Imageutility. This is important when there may be multiple barcodes in
 * an Imageutility, and detecting a barcode may find parts of multiple barcode and fail to decode
 * (e.g. QR Codes). Instead this scans the four quadrants of the Imageutility -- and also the center
